...
NSString* const kCoreDataLocation = @"Base.sqlite";
NSString* const kCoreDataModelName = @"Base";
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL* documentsFolderURL = [NSURL fileURLWithPath:[CoreDataManager documentsFolderPath]];
